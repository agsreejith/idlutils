PRO myhist, arr, xhist,yhist, BIN=bin,  NOPLOT=NoPlot, $
OVERPLOT=Overplot, $
...
Color = color, xtickname=xtickname, xticks=xticks
;+
; NAME:
;      PLOTHIST
; PURPOSE:
...
;			~Added xtickname and xticks February 23, 2011 ~MJG
;-
;			Check parameters.
...
;
 ...
 if keyword_set(Overplot) then begin
	...
	xlog = xlog, ylog = ylog, yrange=yrange, xtickname=xtickname, xticks=xticks
 endelse
