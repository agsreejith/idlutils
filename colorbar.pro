...
ENDELSE
   ...
   IF KEYWORD_SET(FAP) THEN BEGIN
      ...
      PLOT, [min,max], [min,max], /NODATA, XTICKS=1, $
         YTICKS=1, XSTYLE=9, YSTYLE=9, $
         POSITION=position, COLOR=color, CHARSIZE=charsize, /NOERASE, $
         YTICKFORMAT='(A1)', XTICKFORMAT='(A1)', YTICKLEN=0 , $
         YRANGE=[0, 1], YTITLE=title

;      AXIS, YAXIS=1, YRANGE=[0, 1], YTICKFORMAT=format, YTICKS=divisions, $
;         YTICKLEN=0.1, YSTYLE=1, COLOR=color, CHARSIZE=charsize

;      AXIS, XAXIS=0, XRANGE=[0, 1], XTICKFORMAT=format, XTICKS=divisions, $
;         XTICKLEN=0.1, XSTYLE=1, COLOR=color, CHARSIZE=charsize
stop
   ENDIF
