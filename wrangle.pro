...
; NAME: 	WRANGLE.PRO
;																	   
; PURPOSE:    To open the procedure desired with textwrangler
;																	   
; CATEGORY: EXOPLANETS							   
;																	   
; CALLING SEQUENCE:													   
...
;																	   
; OUTPUTS:	opens the desired procedure in textwrangler														   
;																	   
...
;     c. Matt Giguere, Monday, October 15, 2007						   
;***********************************************************************
