...
; EXAMPLES:
;       The call:
;               legendpro,['Plus sign','Asterisk','Period'],psym=[1,2,3]
;         produces:
;               -----------------
;               |               |
;               |  + Plus sign  |
...
;		changed from legend.pro to legendpro.pro since IDL built this routine
;		into it's system as a function for the new, functional plotting methods. M. Giguere 3/2011
;		
;-
pro legendpro, items, BOTTOM_LEGEND=bottom, BOX = box, CENTER_LEGEND=center, $
