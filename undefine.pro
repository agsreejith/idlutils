...
;       Simplified program so you can pass it an undefined
;       variable. :-) 17 May 2000. DWF
;       Simplified it even more by removing the unnecessary SIZE
;       function. 28 June 2002. DWF.
;-
